...
function App(props) {
  ...
  const purpose = useContractReader(readContracts, "CyberneticOrganism", "purpose", [], localProviderPollingTime);
  ...
  return (
    <div className="App">
      ...
      <Menu style={{ textAlign: "center", marginTop: 20 }} selectedKeys={[location.pathname]} mode="horizontal">
        ...
        <Menu.Item key="/debug1">
          <Link to="/debug1">Debug Cybernetic Organism</Link>
        </Menu.Item>
        ...
        <Menu.Item key="/debug4">
          <Link to="/debug4">Debug Cyborg</Link>
        </Menu.Item>
        <Menu.Item key="/debug5">
          <Link to="/debug5">Debug Weapon</Link>
        </Menu.Item>
        <Menu.Item key="/debug6">
          <Link to="/debug6">Debug Program</Link>
        </Menu.Item>
