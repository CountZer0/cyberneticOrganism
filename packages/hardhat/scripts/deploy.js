...
const main = async () => {
  ...
  const CyberneticOrganism = await deploy("CyberneticOrganism"); // <-- add in constructor args like line 19 vvvv
  ...
  */
  ...
  await tenderlyVerify(
    {contractName: "CyberneticOrganism",
     contractAddress: CyberneticOrganism.address
  })
  */
