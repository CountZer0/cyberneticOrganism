...
function getStyle(uint roll) pure returns (bytes memory){
...
function getFeature(uint roll) pure returns (bytes memory){
...
function getObsession(uint roll) pure returns (bytes memory){
...
function getWants(uint roll) pure returns (bytes memory){
...
function getQuirk(uint roll) pure returns (bytes memory){
